<%@ Page Title="" Language="C#" MasterPageFile="~/tos/reg.master" AutoEventWireup="true" CodeFile="panapply.aspx.cs" Inherits="tos_panapply" %>
<%@ PreviousPageType  VirtualPath="~/services.aspx" %>
    ...
    <article>
        ...
        <%--<table>
            ...
            <table class="auto-style1">
                <tr><td>Text is</td><td><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></td></tr>
        <tr>
