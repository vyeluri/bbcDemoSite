<%@ Page Title="" Language="C#" MasterPageFile="~/tos/reg.master" AutoEventWireup="true" CodeFile="pancorrection.aspx.cs" Inherits="tos_pancorrection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <article>
        ...
        <h3>For Pan Card Corrections</h3>
        ...
        <tr>
            ...
            <td style="text-align: right">
                ...
                <asp:label ID="PanCardNo" runat="server" Font-Bold="True" Font-Names="Tahoma" 
            ...
            <td>
                ...
                <asp:textbox ID="pancardNoBox" runat="server" CssClass="TextBox" Width="216px" 
